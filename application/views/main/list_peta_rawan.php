<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> Daftar Pengguna
    <small></small>
</h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <div class="btn-group btn-group-devided">
                <a href="<?php echo site_url('admin/peta_rawan') ?>"><button class="btn btn-sm blue btn-outline"> <i class="fa fa-map"></i> Lihat Peta</button></a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                <thead>
                    ...
                    <tr role="row" class="filter">
                        ...
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="filter_nik">
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="filter_kecamatan">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="filter_pekerjaan">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="filter_jenis_kelamin">
                        </td>
                        <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-filter" action="javascript:;" target="_blank" <label>Periode : </label>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group date date-picker margin-bottom-5" data-date-format="dd/mm/yyyy">
    ...
    function delete_list(id) {
        bootbox.confirm("Apakah anda yakin menghapus data ini?", function(result) {
            if (result == true) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('admin/deleteList') ?>',
                    data: {
                        'id': id
                    },
                    success: function() {
        ...
        var handleRecords = function() {
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('admin/ajax_list_pengaduan'); ?>" // ajax source
                    },
